---
date: 15-02-2026
description: Μάθετε πώς να εξαγάγετε αρχεία zip σε φάκελο χρησιμοποιώντας το Aspose.Zip για .NET συμπεριλαμβανομένων αρχείων που προστατεύονται με κωδικό πρόσβασης και κρυπτογραφημένης εξαγωγής zip.
