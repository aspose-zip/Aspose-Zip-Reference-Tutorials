...
## パスワード保護された解凍にAspose.Zipを使用する理由
...
## Aspose.Zip を使用してパスワード付き ZIP ファイルを解凍する方法
...
### ステップ 2: 異なるパスワードでアーカイブ エントリを解凍する
...
#### ステップ 2.2: 最初のエントリを解凍する (パスワード=“first_pass”)
...
#### ステップ 2.3: 2 番目のエントリを解凍する (パスワード=“second_pass”)
...
#### ステップ 2.4: (オプション) すべてのエントリをループ処理する
