...
## Aspose.Zip を使用してファイルを tar.gz に圧縮する理由
...
## Aspose.Zip for .NET を使用して tar にファイルを追加する方法
...
#### 2.2 ファイルの追加 – 「tar.gzへのファイル追加」の核心部分
...
#### 2.3 Gzip圧縮tar.gzとして保存（tar.gzの圧縮方法）
