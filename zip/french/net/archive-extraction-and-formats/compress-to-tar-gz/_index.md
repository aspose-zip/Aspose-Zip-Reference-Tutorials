...
- **Puis-je compresser directement sur tar.gz ?** Oui—appelez `SaveGzipped`.
...
## Qu'est-ce que « ajouter des fichiers à tar » ?
...
- **Ensemble de fonctionnalités riches** – prend en charge le chiffrement, la protection par mot de passe et les attributs d'entrée personnalisés.
...
## Comment ajouter des fichiers à une archive tar avec Aspose.Zip pour .NET
...
#### 2.2 Ajouter des fichiers – le cœur de l’opération « ajouter des fichiers à une archive tar »
...
#### 2.3 Enregistrer au format Tar compressé (compresser un fichier tar.gz)
...
| Scénario | Pourquoi «ajouter des fichiers à tar» aider |
|----------|------------------------------------|
