---
description: Apprenez à extraire des fichiers RAR vers un dossier et à déchiffrer
  les fichiers RAR cryptés à l’aide d’Aspose.Zip pour .NET. Suivez le guide étape
  par étape pour lire un fichier RAR crypté et spécifier le mot de passe du RAR.
linktitle: Decrypting a RAR Archive
second_title: Aspose.Zip .NET API for Files Compression & Archiving
title: Extraire un RAR vers un dossier avec Aspose.Zip pour .NET
