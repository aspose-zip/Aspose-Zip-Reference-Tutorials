...
學習如何使用 Aspose.Zip 在 .NET 中將檔案壓縮為 TarBz2 格式。請按照我們的逐步指南進行操作，以實現高效的檔案壓縮。
### [使用 Aspose.Zip for .NET 壓縮為 TarGz](./compress-to-tar-gz/)
探索使用 Aspose.Zip 在 .NET 中實現高效的檔案壓縮。輕鬆壓縮為 TarGz 格式。
### [使用 Aspose.Zip for .NET 壓縮為 TarLz](./compress-to-tar-lz/)
使用 Aspose.Zip 在 .NET 中輕鬆壓縮檔案。學習如何逐步建立 TarLz 歸檔檔案。
### [使用 Aspose.Zip for .NET 壓縮為 TarXz](./compress-to-tar-xz/)
學習如何使用 Aspose.Zip 在 .NET 中將檔案壓縮為 TarXz 格式。請按照我們的逐步指南進行操作，以實現高效的文件儲存和傳輸。
### [使用 Aspose.Zip for .NET 壓縮為 TarZ](./compress-to-tar-z/)
探索使用 Aspose.Zip for .NET 逐步壓縮為 TarZ 格式。為您的 .NET 專案提供高效率的文件處理。
### [在 Aspose.Zip for .NET 中使用不同密碼解壓縮條目](./extract-archive-different-passwords/)
學習如何在 Aspose.Zip for .NET 中提取具有不同密碼的歸檔項目。提升應用程式的安全性和靈活性。
